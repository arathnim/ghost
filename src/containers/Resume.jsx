    ...
    return (
        <div className={styles.content}>
          <div className={styles.contentheader}>
            <div className={styles.h2}>Resume</div>
            <div style={{ fontWeight: '300', marginBottom: '30px'}}>Contact and Work</div>
            <Divider />
            ...
            <div>
              ...
              <div style={{ display: 'flex', marginTop: '10px', marginBottom: '30px'}}>
                ...
                <div style={{ width: '200px', minWidth: '200px', marginRight: '70px', marginTop: '18px', textAlign: 'left'}}>
                  ...
                  <div style={{marginBottom: '0.2em'}}><a href="https://github.com/arathnim">Github</a></div>
                </div>
